        ...
        <>
            ...
            <div className="fr-callout fr-mb-4w">
                <Text className="fr-callout__text fr-text--sm">
                    <strong>Qui sont les enseignants non permanents ?</strong>
                    <br />
                    Les enseignants non permanents regroupent l'ensemble des personnels enseignants
                    non titulaires : attachés temporaires d'enseignement et de recherche (ATER),
                    doctorants contractuels chargés d'enseignement, enseignants contractuels,
                    professeurs invités et vacataires. Recrutés pour une durée limitée, ils assurent
                    des missions d'enseignement — et parfois de recherche — en complément des
                    personnels titulaires et jouent un rôle important dans la souplesse
                        ...
                        {categories.map((cat: any, idx: number) => {
                            ...
                            return (
                                <Accordion
                                    ...
                                    title={`${cat.categoryName || cat.categoryCode} · ${scTotal.toLocaleString("fr-FR")} enseignants non permanents`}
                                    titleAs="h4"
