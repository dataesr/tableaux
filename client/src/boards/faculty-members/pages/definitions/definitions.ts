export const definitions = [
  ...
  },
  {
    ...
    definition:
      "Contractuel temporaire assurant des missions d'enseignement et, le cas échéant, de recherche dans un établissement d'enseignement supérieur. Le contrat est d'une durée d'un an renouvelable une fois. Les ATER sont comptés dans la catégorie des non-permanents.",
  },
  {
    title: "Vacataire",
    definition:
      "Personne extérieure à l'établissement recrutée pour assurer ponctuellement des heures d'enseignement. Les vacataires sont rémunérés à l'heure et ne sont pas titulaires d'un poste. Ils font partie des non-permanents.",
  },
  {
    title: "Positionnement relatif",
    definition:
      "Comparaison d'un établissement, d'une région ou d'une discipline par rapport à l'ensemble des entités du même type pour un indicateur donné. Permet d'identifier des spécificités structurelles par rapport à la moyenne nationale.",
  },
  {
    title: "Catégorie d'assimilation",
    definition:
      "Classification des enseignants-chercheurs selon leur corps et grade réels tels que reconnus administrativement (Professeurs et assimilés, Maîtres de conférences et assimilés). Cette catégorie agrège les corps proches pour faciliter les comparaisons.",
  },
  {
