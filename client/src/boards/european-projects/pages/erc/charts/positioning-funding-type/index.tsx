...
const getConfig = (metric: MetricType) => {
  ...
  return {
    ...
    integrationURL: isProjects ? "/european-projects/components/pages/erc/charts/positioning-funding-type" : "/european-projects/components/pages/erc/charts/positioning-funding-type-funding",
  };
};
