...
const getConfig = (metric: MetricType) => {
  ...
  return {
    ...
    integrationURL: isProjects ? "/european-projects/components/pages/msca/charts/positioning-global" : "/european-projects/components/pages/msca/charts/positioning-global-funding",
  };
};
