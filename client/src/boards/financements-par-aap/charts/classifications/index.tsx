...
export default function Classifications({ name, participantSuperOrganizationChildrenIds = [] }: { name: string | undefined, participantSuperOrganizationChildrenIds?: any[] }) {
  ...
  const { data, isLoading } = useQuery({
    queryKey: ["fundings-classifications", region, structures, yearMax, yearMin],
    queryFn: () =>
