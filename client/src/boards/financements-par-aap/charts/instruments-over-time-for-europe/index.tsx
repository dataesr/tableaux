...
export default function InstrumentsOverTimeForEurope({ name, participantSuperOrganizationChildrenIds = [] }: { name: string | undefined, participantSuperOrganizationChildrenIds?: any[] }) {
  ...
  const config = {
    comment: {
      "fr": <>{`Ce graphique présente l’évolution temporelle du nombre de projets ou de leurs financements associés, ventilée par 
        ...
        assimilant consommation et subvention pour le PIA).${withComponents ? " Ici, le périmètre est constitué d'une \
