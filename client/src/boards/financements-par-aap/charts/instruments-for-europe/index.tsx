...
export default function InstrumentsForEurope({ name, participantSuperOrganizationChildrenIds = [] }: { name: string | undefined, participantSuperOrganizationChildrenIds?: any[] }) {
  ...
  const { data, isLoading } = useQuery({
    queryKey: ["fundings-instruments-for-europe", region, structures, yearMax, yearMin],
    queryFn: () =>
