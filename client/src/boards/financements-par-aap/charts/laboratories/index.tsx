...
export default function Laboratories({ name, participantSuperOrganizationChildrenIds = [] }: { name: string | undefined, participantSuperOrganizationChildrenIds?: any[] }) {
  ...
  const { data, isLoading } = useQuery({
    queryKey: ["fundings-laboratories", region, structures, yearMax, yearMin],
    queryFn: () =>
